          ...
          children: [
            Expanded(
              child: QuickActionCard(
                ...
                title: 'My Orders',
                subtitle: ordersCount > 0 ? '$ordersCount In Progress' : 'No active orders',
            ...
            Expanded(
              child: QuickActionCard(
                ...
                title: 'Wishlist',
                subtitle: wishlistCount > 0 ? '$wishlistCount Items' : 'Saved favorites',
                badgeText: wishlistCount > 0 ? '$wishlistCount' : null,
                onTap: onWishlistTap,
              ),
            ),
          ],
